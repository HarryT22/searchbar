...
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id,version) VALUES ('Fleisch A',25,15,6,'MITTAGESSEN',FALSE,FALSE,1,0);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id,version) VALUES ('Fleisch B',25,15,6,'MITTAGESSEN',FALSE,FALSE,2,0);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id,version) VALUES ('Fleisch C',25,15,6,'MITTAGESSEN',FALSE,FALSE,3,0);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id,version) VALUES ('Fleisch D',25,15,6,'MITTAGESSEN',FALSE,FALSE,4,0);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id,version) VALUES ('Fleisch E',25,15,6,'MITTAGESSEN',FALSE,FALSE,5,0);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id,version) VALUES ('Fleisch F',25,15,6,'MITTAGESSEN',FALSE,FALSE,6,0);
