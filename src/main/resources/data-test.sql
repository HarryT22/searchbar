...
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id) VALUES ('Test Fleisch A',25,15,6,'MITTAGESSEN',FALSE,FALSE,1);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id) VALUES ('Test Fleisch B',25,15,6,'MITTAGESSEN',FALSE,FALSE,2);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id) VALUES ('Test Fleisch C',25,15,6,'MITTAGESSEN',FALSE,FALSE,2);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id) VALUES ('Test Fleisch D',25,15,6,'MITTAGESSEN',FALSE,FALSE,2);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id) VALUES ('Test Fleisch E',25,15,6,'MITTAGESSEN',FALSE,FALSE,2);
INSERT INTO rezepte(name,arbeitszeit,kochzeit,portionen,menueart,is_vegan,is_vegetarisch,unvertraeglichkeiten_id) VALUES ('Test Fleisch F',25,15,6,'MITTAGESSEN',FALSE,FALSE,2);
