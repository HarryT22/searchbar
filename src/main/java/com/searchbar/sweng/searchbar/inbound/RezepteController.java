...
public class RezepteController {
    ...
    /**
     * Search for recipies with keyword, intolerances, vegan/vegetarian, amount of protein and calories
     * @param name of the recipie
     ...
     * @return list of recipies based on user role
     */
    ...
    /**
     * Save a recipie construct(without food list)
     * @param rezeptName name of the recipie
     * @param arbeitszeit time to prepare the recipie
     * @param kochzeit time to cook the recipie
    ...
    /**
     * Add a food to food list of specific recipie(id)
     ...
     * @return updated recipie object
     */
    @PreAuthorize("hasAuthority('ADMIN')")
    @PostMapping("/{id}/addF/{name}/{k}/{p}/{menge}")
